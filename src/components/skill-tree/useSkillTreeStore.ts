...
const defaultSkills: Skill[] = [
  {
    id: 'root',
    name: 'Self',
    description: 'Your foundation. All growth stems from knowing yourself.',
    difficulty: 'medium',
    level: 0,
    currentXP: 0,
    requiredXP: 100,
  ...
  },
  {
    id: 'fitness',
    name: 'Fitness',
    description: 'Physical exercise and body conditioning.',
    difficulty: 'medium',
    level: 0,
    currentXP: 0,
    requiredXP: 100,
  ...
  },
  {
    id: 'mindfulness',
    name: 'Mindfulness',
    description: 'Meditation, presence, and mental clarity.',
    difficulty: 'medium',
    level: 0,
    currentXP: 0,
    requiredXP: 100,
  ...
  },
  {
    id: 'productivity',
    name: 'Productivity',
    description: 'Time management and getting things done.',
    difficulty: 'hard',
    level: 0,
    currentXP: 0,
    requiredXP: 100,
  ...
  },
  {
    id: 'learning',
    name: 'Learning',
    description: 'Reading, courses, and skill acquisition.',
    difficulty: 'medium',
    level: 0,
    currentXP: 0,
    requiredXP: 100,
